...
def main():
    ...
    # 定义文件夹路径
    base_depth_folder = '../output/biosp_lidar/train/ours_1/renders_normal'  # 基准深度图文件夹

    # 定义多个比较文件夹集
    comparison_sets = [
        {
            'comparison_folder1': '../output/Task1_it30000_cF_dN_dtM_dw0.2_vF/train/ours_30000/renders_normal',  # 第一个比较文件夹路径
            'comparison_folder2': '../output/Task1_it15000_cF_dMV_dtL_dw0.2_vF/train/ours_15000/renders_normal',  # 第二个比较文件夹路径
            'label': 'Set1'  # 比较集标签
        },
        {
            # 第二个比较文件夹路径
            'comparison_folder1': '../output/Task1_it30000_cF_dMV_dtF_dw0.2_vF/train/ours_30000/renders_normal',
            'comparison_folder2': '../output/Task1_it30000_cF_dMV_dtM_dw0.2_vF/train/ours_30000/renders_normal',  # 第一个比较文件夹路径
            'label': 'Set2'  # 比较集标签
        }
    ]

    # 定义输出的基础路径
    output_base_path = '../output/normal_comparison_output'
